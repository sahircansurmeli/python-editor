...
const OutputFooterWithPercentage: React.FunctionComponent<
  OutputFooterWithPercentageProps
> = (props) => {
  const { children, color, percentage, showAll, setShowAll, showAllDisabled } =
    props
